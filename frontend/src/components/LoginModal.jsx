  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in">
      ...
      >
        ...
        <p className="text-zinc-400 text-center mb-6 text-xs sm:text-sm md:text-sm">
          Your all-in-one campus companion for academics, community, and growth
        </p>

        {error && (
          <p className="text-red-400 text-center mb-4 text-xs sm:text-sm md:text-sm">{error}</p>
        )}
