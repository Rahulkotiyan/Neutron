        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div>
                <h2 className="text-lg sm:text-xl md:text-xl font-semibold text-white">Report</h2>
                <p className="text-xs sm:text-sm md:text-sm text-slate-300">
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              <div>
                <label className="block text-xs sm:text-sm md:text-sm font-semibold text-white mb-3">
                ...
                />
                {selectedCategory && (
                  <p className="text-[0.65rem] sm:text-xs md:text-xs text-slate-400 mt-2 leading-relaxed">
                    {
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-slate-500 rounded-md focus:ring-2 focus:ring-slate-400 focus:border-slate-300 resize-none text-xs sm:text-sm md:text-sm bg-slate-800 text-white placeholder-slate-400"
                  rows={4}
                  maxLength={500}
                />
                <p className="text-[0.65rem] sm:text-xs md:text-xs text-slate-400 mt-2">
          ...
          <div className="mt-6 pt-4 border-t border-slate-600">
            <p className="text-[0.65rem] sm:text-xs md:text-xs text-slate-400 text-center leading-relaxed">
