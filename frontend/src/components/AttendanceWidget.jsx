  ...
  if (!attendance?.subjects || attendance.subjects.length === 0) {
    return (
      <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[2rem] p-6 border border-white/10 shadow-premium">
        <h3 className="text-base sm:text-lg md:text-lg font-black mb-4 uppercase tracking-widest text-zinc-500">Attendance</h3>
  ...
  return (
    <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[2rem] p-6 border border-white/10 shadow-premium">
      ...
      <div className="space-y-2">
        <p className="text-[0.65rem] sm:text-xs md:text-xs text-zinc-400 font-medium mb-2">TOP SUBJECTS</p>
        {attendance.subjects.slice(0, 3).map((subject) => (
          ...
          >
            <div className="flex-1">
              ...
              <p className="text-[0.65rem] sm:text-xs md:text-xs text-zinc-400">{subject.subjectCode}</p>
            </div>
            <div className="flex items-center gap-2">
              <div className="text-right">
                <p className="text-xs sm:text-sm md:text-sm font-bold">
