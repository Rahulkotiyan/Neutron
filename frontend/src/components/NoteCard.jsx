...
const NoteCard = ({ note, currentUser, isLikedByUser, getLikesCount, onView, onDelete, onLike, onShare, formatDate, setModalConfig }) => {
  return (
    ...
    >
      <div className="px-3 md:px-6 pt-3 md:pt-6 pb-1 md:pb-4 flex items-start justify-between gap-4">
        ...
        {currentUser?.isAdmin && (
          <button
            ...
            className="p-3 md:p-2 text-zinc-500 hover:text-red-500 hover:bg-red-500/10 rounded-full transition-all shrink-0 active:scale-95 min-h-[44px]"
          >
      ...
      <div className="px-3 md:px-6 pt-0 flex-1 flex flex-col">
      ...
      <div className="px-3 md:px-6 py-2.5 md:py-4 border-t border-white/5 bg-black/20 flex items-center justify-between">
        <div className="flex gap-3 md:gap-4">
          <button
            ...
            className={`flex items-center gap-1 md:gap-1.5 text-[10px] md:text-xs font-bold transition-colors active:scale-95 min-h-[44px] ${
          ...
          <button
            ...
            className="flex items-center gap-1 md:gap-1.5 text-[10px] md:text-xs font-bold text-zinc-500 hover:text-green-400 hover:bg-green-500/10 px-1.5 md:px-2 py-0.5 md:py-1 rounded-full transition-all active:scale-95 min-h-[44px]"
          >
