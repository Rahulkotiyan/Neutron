  ...
  if (!todaySchedule?.classes || todaySchedule.classes.length === 0) {
    return (
      <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[2rem] p-6 border border-white/10 shadow-premium">
        <h3 className="text-[10px] md:text-xs font-black mb-4 flex items-center gap-2 uppercase tracking-widest text-zinc-500">
  ...
  return (
    <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[2rem] p-6 border border-white/10 shadow-premium">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-[10px] md:text-xs font-black flex items-center gap-2 uppercase tracking-widest text-zinc-500">
          <Book size={16} /> Today's Core
        </h3>
        <Link
          to="/timetable"
      ...
      {currentClass?.current && (
        <div className="mb-6 bg-white text-black rounded-2xl p-5 shadow-premium">
          <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.25em] opacity-60 mb-1">
            Active Core
          </p>
