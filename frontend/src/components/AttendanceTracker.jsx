    ...
    <div className="space-y-6">
      ...
      {attendance && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg p-6">
            <p className="text-xs sm:text-sm md:text-base text-blue-200 mb-2">Total Classes</p>
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-800 rounded-lg p-6">
            <p className="text-xs sm:text-sm md:text-base text-green-200 mb-2">Classes Attended</p>
            <p className="text-3xl font-bold">
          ...
          <div className="bg-gradient-to-br from-red-600 to-red-800 rounded-lg p-6">
            <p className="text-xs sm:text-sm md:text-base text-red-200 mb-2">Classes Skipped</p>
            <p className="text-3xl font-bold">
              {attendance.subjects.reduce(
          ...
          <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-lg p-6">
            <p className="text-xs sm:text-sm md:text-base text-purple-200 mb-2">Overall %</p>
            <p className="text-3xl font-bold">
      ...
      {bunkAnalysis && (
        <div className="bg-zinc-800 rounded-lg p-6">
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-6 flex items-center gap-2">
              ...
              >
                ...
                <div className="mb-4">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-xs sm:text-sm md:text-base text-zinc-300">Attendance</span>
                ...
                {/* Classes Info */}
                <div className="grid grid-cols-3 gap-2 text-xs sm:text-sm md:text-base mb-4">
                  <div>
                ...
                {subject.warning === "SAFE" ? (
                  <div className="bg-green-900/20 border border-green-700 rounded p-3">
                    <p className="text-xs sm:text-sm md:text-base font-medium text-green-300 flex items-center gap-2">
                      <GraphUp iconSize={16} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-7 gap-2 mb-4">
                {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
                  (day) => (
                    <div
                      key={day}
                      className="text-center font-semibold text-xs sm:text-sm md:text-base text-zinc-400 p-2"
                    >
                      {day}
                    </div>
                  ),
              ...
              <div className="grid grid-cols-7 gap-2">
                {Array.from({ length: 42 }, (_, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`aspect-square rounded flex items-center justify-center text-xs sm:text-sm md:text-base font-medium ${
                        record
              ...
              <div className="flex gap-4 mt-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs sm:text-sm md:text-base">Present</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 bg-red-600 rounded" />
                  <span className="text-xs sm:text-sm md:text-base">Absent</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 bg-yellow-600 rounded" />
                  <span className="text-xs sm:text-sm md:text-base">Leave</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-zinc-700/50 rounded p-4">
                <p className="text-xs sm:text-sm md:text-base text-zinc-400 mb-2">Total Classes</p>
                <p className="text-2xl font-bold">
                  {subjectCalendar.stats.totalClasses}
                </p>
              </div>
              <div className="bg-green-900/20 border border-green-700 rounded p-4">
                <p className="text-xs sm:text-sm md:text-base text-green-300 mb-2">Present</p>
                <p className="text-2xl font-bold text-green-400">
                  {subjectCalendar.stats.attended}
                </p>
              </div>
              <div className="bg-red-900/20 border border-red-700 rounded p-4">
                <p className="text-xs sm:text-sm md:text-base text-red-300 mb-2">Absent</p>
                <p className="text-2xl font-bold text-red-400">
                  {subjectCalendar.stats.absent}
                </p>
              </div>
              <div className="bg-yellow-900/20 border border-yellow-700 rounded p-4">
                <p className="text-xs sm:text-sm md:text-base text-yellow-300 mb-2">Leave</p>
