    ...
    <div className="sticky top-24 space-y-6 p-4">
      ...
      <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/50 rounded-2xl border border-white/10 p-6 backdrop-blur-sm hover:border-white/20 transition-all">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white">Trending Today</h2>
        </div>
            ...
            trendingTopics.map((item, idx) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs sm:text-sm md:text-base font-bold text-blue-400">
                    #{idx + 1} Trending
                  </span>
                  <span className="text-[0.65rem] sm:text-xs md:text-sm bg-orange-500/20 text-orange-400 px-2 py-1 rounded-full font-medium">
                    {item.count} posts
                  </span>
                </div>
                <p className="text-sm sm:text-base md:text-lg font-bold text-white group-hover:text-blue-400 transition-colors">
                  {item.topic.substring(1)}
                </p>
                <p className="text-[0.65rem] sm:text-xs md:text-sm text-zinc-500 mt-1">
                  {item.count}K discussions
                </p>
              </div>
            ))
          ) : (
            <p className="text-xs sm:text-sm md:text-base text-zinc-500 text-center py-4">
      ...
      <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/50 rounded-2xl border border-white/10 p-6 backdrop-blur-sm hover:border-white/20 transition-all">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white">Top This Week</h2>
        </div>
            ...
            trendingPosts.map((post, idx) => (
              ...
              >
                <div className="flex gap-3">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-xs sm:text-sm md:text-base">
                    {idx + 1}
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs sm:text-sm md:text-base font-bold text-white truncate group-hover:text-blue-400 transition-colors">
                      {post.title || post.desc?.substring(0, 50)}
                    </p>
                    <div className="flex items-center gap-2 mt-2 text-[0.65rem] sm:text-xs md:text-sm text-zinc-400">
      ...
      <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 rounded-2xl border border-blue-500/20 p-4 backdrop-blur-sm">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs sm:text-sm md:text-base font-bold text-blue-300 mb-1">Premium Tips</p>
            <p className="text-[0.65rem] sm:text-xs md:text-sm text-blue-200/70">
      ...
      <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-800/50 rounded-2xl border border-white/10 p-6 backdrop-blur-sm hover:border-white/20 transition-all">
        <h3 className="text-xs sm:text-sm md:text-base font-bold text-white mb-4">
          Communities for You
        </h3>
        <div className="space-y-3">
          {[
            ...
            >
              <p className="text-xs sm:text-sm md:text-base font-medium text-white">{community}</p>
            </button>
          ))}
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="text-center text-[0.65rem] sm:text-xs md:text-sm text-zinc-600 space-y-1 pb-4">
