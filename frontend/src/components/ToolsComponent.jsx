  ...
  const renderTab = (tab, className = "") => {
    ...
    return (
      <button
        ...
        disabled={isDisabled}
        className={`flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl font-semibold text-xs sm:text-sm md:text-base transition-all duration-300 whitespace-nowrap ${className} ${
           activeTab === tab.id
        ...
        <div className="flex flex-col items-center mt-8">
          ...
          <div className="hidden md:flex flex-col items-center w-full max-w-xl gap-2">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-xs sm:text-sm md:text-base transition-all duration-300 ${
                activeTab === "tools-oss"
                  ? "bg-white text-black shadow-lg"
                  : "bg-zinc-900/40 border border-white/5 text-zinc-400 hover:border-white/20 hover:bg-zinc-900/60"
              }`}
          ...
          <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {currentClass?.current && (
                  <div className="group relative flex flex-col bg-zinc-800/40 backdrop-blur-md border border-white/10 hover:border-white/20 rounded-[2rem] overflow-hidden hover:-translate-y-1 transition-all duration-300 shadow-xl shadow-zinc-900/10 hover:shadow-zinc-900/20 p-8">
                    ...
                    <p className="text-[0.65rem] sm:text-xs md:text-sm font-bold text-zinc-300 uppercase tracking-widest mb-3 opacity-80">
                      ● Live
                    </p>
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/5 hover:border-white/10 rounded-[2rem] p-8 shadow-xl transition-all">
              <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="group relative inline-flex items-center justify-center gap-2 px-4 py-2 bg-zinc-700 text-white rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
                  ...
                  {currentUser && (
                    <button
                      ...
                      className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-black border border-gray-200 rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
                    >
                      <Plus
                        size={18}
                ...
                <div className="min-w-[800px]">
                  ...
                  <div className="grid grid-cols-8 gap-2 mb-4">
                    <div className="p-3 text-center">
                      <p className="text-xs sm:text-sm md:text-base font-bold text-zinc-400 uppercase">Time</p>
                    </div>
                    {daysOfWeek.map((day) => (
                      <div key={day} className="p-3 text-center">
                        <p className="text-xs sm:text-sm md:text-base font-bold text-white">{day.slice(0, 3)}</p>
                      </div>
                    ))}
                  </div>
                    ...
                    return (
                      <div key={timeSlot} className="grid grid-cols-8 gap-2 mb-2">
                        ...
                        <div className="p-3 text-center border border-white/5 rounded-lg bg-zinc-800/30">
                          <p className="text-xs sm:text-sm md:text-base font-semibold text-zinc-300">{timeSlot}</p>
                        </div>
                            ...
                            >
                              {classAtTime ? (
                                <div className="text-center w-full">
                                  <p className="text-[0.65rem] sm:text-xs md:text-sm font-bold text-white mb-1 truncate">
                                    {classAtTime.subject}
                                  </p>
                                ...
                                <div className="text-zinc-600 text-[0.65rem] sm:text-xs md:text-sm opacity-30">
                                  Free
                                </div>
                              )}
                            </div>
              ...
              <div className="mt-6 pt-6 border-t border-white/5">
                <div className="flex flex-wrap gap-4 justify-center text-[0.65rem] sm:text-xs md:text-sm">
          ...
          <div className="space-y-8">
            {!currentUser ? (
              <div className="text-center py-12 px-4 border border-white/5 rounded-2xl bg-zinc-900/20 backdrop-blur-sm">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-2">Login Required for Personal Data</h3>
                <p className="text-zinc-400 mb-6 max-w-md mx-auto">
                  Please login to track your personal attendance data. You can still use the attendance calculator below.
                </p>
                <button
                  onClick={() => setShowCalculatorModal(true)}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-800 text-white rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
                >
                  <Clock size={18} />
              ...
              <div className="bg-zinc-900/40 backdrop-blur-md border border-white/5 hover:border-white/10 rounded-[2rem] p-8 shadow-xl transition-all">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-zinc-400 font-medium">Total Subjects</p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-white mb-2">
                      {getOverallAttendanceStats().averageAttendance}%
                    </p>
                    <p className="text-xs sm:text-sm md:text-base text-zinc-400 font-medium">Average Attendance</p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-white mb-2">
                      {getOverallAttendanceStats().safeSubjects}
                    </p>
                    <p className="text-xs sm:text-sm md:text-base text-zinc-400 font-medium">Safe Subjects</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {(!attendance?.subjects || attendance.subjects.length === 0) && (
              <div className="text-center py-12 px-4 border border-white/5 rounded-2xl bg-zinc-900/20 backdrop-blur-sm">
                <CheckCircle size={48} className="mx-auto mb-4 text-zinc-600" />
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-2">No Subjects Added</h3>
                <p className="text-zinc-400 mb-6 max-w-md mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
                  >
                    <Plus size={18} />
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex flex-col md:flex-row gap-3">
                    <button
                      onClick={() => setShowCalculatorModal(true)}
                      className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-zinc-800 text-white rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
                    >
                      <Clock size={18} />
                    ...
                    <button
                      ...
                      className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-black rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
                    >
                      <Check size={18} />
                      ...
                      >
                        <div className="flex justify-between items-start mb-6">
                          <div className="flex-1">
                            <h4 className="font-bold text-base sm:text-lg md:text-xl text-white mb-1">
                              {subject.subjectName}
                            </h4>
                            <p className="text-[0.65rem] sm:text-xs md:text-sm text-zinc-400 font-semibold">
                              {subject.subjectCode}
                            </p>
                          </div>
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="mb-6">
                            <div className="flex justify-between items-center mb-3">
                              <span className="text-xs sm:text-sm md:text-base font-medium text-zinc-400">
                                Attendance
                              </span>
                          ...
                          {/* Stats */}
                          <div className="grid grid-cols-2 gap-4 text-xs sm:text-sm md:text-base mb-6 p-4 bg-white/5 rounded-xl border border-white/5">
                            <div>
                              <p className="text-[0.65rem] sm:text-xs md:text-sm font-bold text-zinc-500 uppercase mb-1">
                                Total Classes
                              </p>
                          ...
                          {isSafe ? (
                            <div className="bg-zinc-800/50 border border-zinc-600/30 rounded-xl p-4">
                              <p className="text-xs sm:text-sm md:text-base font-bold text-zinc-300 flex items-center gap-2">
                            ...
                            <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-4">
                              <p className="text-xs sm:text-sm md:text-base font-bold text-red-300 flex items-center gap-2">
          ...
          <div className="space-y-8">
            {!currentUser ? (
              <div className="text-center py-12 px-4 border border-white/5 rounded-2xl bg-zinc-900/20 backdrop-blur-sm">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-2">Login Required</h3>
            ...
            {tasks && tasks.length > 0 ? (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => setShowAddTaskModal(true)}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-700/20 border border-zinc-600/30 text-zinc-300 rounded-lg font-bold text-xs sm:text-sm md:text-base transition-all hover:bg-zinc-700/30"
                  >
                    <Plus size={16} />
                    Add Task
                  </button>
...
<p className="text-[0.625rem] font-bold text-zinc-500 uppercase">
                              ...
                              <p className="font-semibold text-white text-xs sm:text-sm md:text-base mt-1">
                                {task.startTime}
                              </p>
                            </div>
                          </div>
...
<p className="text-[0.625rem] font-bold text-zinc-500 uppercase">
                              ...
                              <p className="font-semibold text-white text-xs sm:text-sm md:text-base mt-1 line-clamp-2">
                                {task.instructions}
                              </p>
                            </div>
                          </div>
              ...
              <div className="text-center py-12 px-4 border border-white/5 rounded-2xl bg-zinc-900/20 backdrop-blur-sm">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-2">No Tasks Scheduled</h3>
                <p className="text-zinc-400 mb-6 max-w-md mx-auto">
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-700 rounded-2xl p-6 text-center">
                <p className="text-[0.65rem] sm:text-xs md:text-sm font-bold text-zinc-500 uppercase tracking-wider mb-1">SGPA</p>
                <p className="text-4xl font-bold text-white">{calcSGPA()}</p>
                <p className="text-[0.65rem] sm:text-xs md:text-sm text-zinc-500 mt-1">{getGradeStatus(calcSGPA())}</p>
              </div>
              <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-700 rounded-2xl p-6 text-center">
                <p className="text-[0.65rem] sm:text-xs md:text-sm font-bold text-zinc-500 uppercase tracking-wider mb-1">CGPA</p>
                <p className="text-4xl font-bold text-white">{calcCGPA()}</p>
                <p className="text-[0.65rem] sm:text-xs md:text-sm text-zinc-500 mt-1">{getGradeStatus(calcCGPA())}</p>
              </div>
            </div>

            {/* Previous GPA (optional) */}
            <details className="bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-2xl">
              <summary className="px-5 py-3 text-xs sm:text-sm md:text-base font-semibold text-zinc-400 cursor-pointer hover:text-white transition-colors select-none">
                Include previous CGPA for accurate overall CGPA
              </summary>
              <div className="px-5 pb-4 grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[0.65rem] sm:text-xs md:text-sm font-medium text-zinc-500 mb-1">Previous CGPA</label>
                  <input type="number" step="0.01" min="0" max="10"
                    value={prevCGPA}
                    onChange={e => setPrevCGPA(e.target.value)}
                    className="w-full px-3 py-2 bg-zinc-800 border border-white/10 rounded-lg text-white text-xs sm:text-sm md:text-base focus:outline-none focus:border-white/20 transition-colors"
                    placeholder="e.g. 8.5" />
                </div>
                <div>
                  <label className="block text-[0.65rem] sm:text-xs md:text-sm font-medium text-zinc-500 mb-1">Previous Credits</label>
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-2xl p-5">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xs sm:text-sm md:text-base font-bold text-zinc-300">Subjects</h3>
                <button onClick={addGpaSubject}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-white text-black rounded-full font-bold text-[0.65rem] sm:text-xs md:text-sm transition-all hover:scale-105 active:scale-95">
                  <Plus size={14} />
                  Add
                </button>
              </div>
              ...
              {gpaSubjects.length === 0 ? (
                <div className="text-center py-6 border border-dashed border-white/5 rounded-lg">
                  <p className="text-zinc-500 text-xs sm:text-sm md:text-base">No subjects added yet</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {gpaSubjects.map((s, i) => (
                    <div key={s.id} className="flex items-center gap-2 bg-zinc-800/30 border border-white/5 rounded-lg px-3 py-2">
                      <span className="text-[0.65rem] sm:text-xs md:text-sm text-zinc-500 w-5 shrink-0">{i + 1}.</span>
                      <input type="number" min="0" max="10" step="0.5"
                        value={s.credits} placeholder="Credits"
                        onChange={e => updateGpaSubject(s.id, 'credits', e.target.value)}
                        className="w-20 px-2 py-1.5 bg-zinc-900 border border-white/10 rounded text-white text-[0.65rem] sm:text-xs md:text-sm text-center focus:outline-none focus:border-white/20 transition-colors" />
              ...
              {gpaSubjects.length > 0 && (
                <div className="mt-3 pt-3 border-t border-white/5 flex justify-between text-[0.65rem] sm:text-xs md:text-sm text-zinc-500">
            ...
            <div className="flex flex-col max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 md:p-8 space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div>
                    <label className="block text-xs sm:text-sm md:text-base font-bold text-white mb-2 tracking-tight">
                      Day
                    </label>
                    <CustomDropdown
                      colorScheme="blue"
                ...
                <div className="flex items-center gap-3 p-4 bg-zinc-800/20 border border-zinc-600/30 rounded-lg">
                  ...
                  />
                  <label className="text-xs sm:text-sm md:text-base font-medium text-white cursor-pointer">
              ...
              <div className="sticky bottom-0 bg-gradient-to-t from-zinc-950 to-zinc-950/50 backdrop-blur-md border-t border-white/5 p-6 md:p-8 flex gap-3 justify-end">
                <button
                  onClick={() => setShowAddClassModal(false)}
                  className="px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-white text-xs sm:text-sm md:text-base font-bold rounded-lg transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-zinc-700 hover:bg-zinc-600 text-white text-xs sm:text-sm md:text-base font-bold rounded-lg transition-all disabled:opacity-50 shadow-lg"
                >
                  {loading ? (
                    <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["PRESENT", "ABSENT"].map((status) => (
                    <button
                      ...
                      className={`p-3 rounded-lg font-bold text-xs sm:text-sm md:text-base transition-all ${
          ...
          <div className="w-full max-w-md bg-zinc-950 border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="p-6 md:p-8">
              <div className="bg-red-900/20 border border-red-500/30 rounded-xl p-4 mb-6">
                <p className="text-xs sm:text-sm md:text-base text-red-300">
              ...
              <div className="space-y-3 text-xs sm:text-sm md:text-base text-zinc-400">
            ...
            <div className="bg-gradient-to-t from-zinc-950 to-zinc-950/50 backdrop-blur-md border-t border-white/5 p-6 md:p-8 flex gap-3 justify-end">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white text-xs sm:text-sm md:text-base font-bold rounded-lg transition-all disabled:opacity-50 shadow-lg shadow-red-900/30"
              >
                {loading ? (
                  <>
                    <Clock size={16} className="animate-spin" />
              ...
              {deleteSuccessMessage && (
                <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-4 animate-in slide-in-from-top duration-300">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-green-300 font-medium">
                      {deleteSuccessMessage}
                    </p>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-xl animate-in fade-in duration-300">
          <div className="w-full max-w-lg sm:max-w-xl bg-zinc-950 border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 max-h-[90vh] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-5">
              ...
              {calculatorForm.totalClasses > 0 && (
                <div className="bg-zinc-800/30 border border-white/5 rounded-xl p-4 sm:p-6 space-y-4">
                  <div className="text-center">
                    <p className="text-xs sm:text-sm md:text-base font-medium text-zinc-400 mb-2">Current Attendance</p>
                  ...
                  <div className="text-center p-3 sm:p-4 bg-zinc-900/50 rounded-lg">
                    ...
                    <p className="text-[0.65rem] sm:text-xs md:text-sm text-zinc-400">Can Bunk</p>
                  </div>

                  <div className="text-center">
                    <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-[0.65rem] sm:text-xs md:text-sm font-bold ${
            ...
            <div className="bg-gradient-to-t from-zinc-950 to-zinc-950/50 backdrop-blur-md border-t border-white/5 p-6 md:p-8 mt-auto">
              <button
                onClick={() => setShowCalculatorModal(false)}
                className="w-full px-6 py-3 bg-white text-black rounded-full font-bold text-xs sm:text-sm md:text-base transition-all hover:scale-105 active:scale-95 shadow-lg"
              >
                Close Calculator
              </button>
            </div>
            ...
            <div className="flex flex-col max-h-[90vh] overflow-y-auto">
              ...
              <div className="sticky bottom-0 bg-gradient-to-t from-zinc-950 to-zinc-950/50 backdrop-blur-md border-t border-white/5 p-6 md:p-8 flex gap-3 justify-end">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center gap-2 px-6 py-3 bg-white hover:bg-gray-50 text-black border border-gray-200 text-xs sm:text-sm md:text-base font-bold rounded-lg transition-all "
                >
                  {loading ? (
                    <>
                      <Clock size={16} className="animate-spin" />
